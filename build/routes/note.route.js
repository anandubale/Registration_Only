...
var _reddis = require("../middlewares/reddis.middleware");
...
noteRouter.post('', _note2.newNoteValidator, _auth.NoteAuthentication, noteController.create); //get all notes 

noteRouter.get('', _auth.NoteAuthentication, _reddis.cached_data_Redis, noteController.AllNotes); //get note by id

noteRouter.get('/:_id', _auth.NoteAuthentication, noteController.getNoteById); //update using put

noteRouter.put('/:_id', _auth.NoteAuthentication, noteController.updateById); //delete by id:

noteRouter["delete"]('/:_id', _auth.NoteAuthentication, noteController.deleteNote); //have to change is arcive to true by id
